				...
				<div class="container">
					...
					<div class="row fullscreen d-flex align-items-center justify-content-end">
						<div class="banner-content col-lg-6 col-md-12 mt-30">
							...
							<button class="primary-btn mt-20 mb-20 text-uppercase anim3 animated fadeInUpBig"><a href="http://www.karunya.edu">Learn More<span class="lnr lnr-arrow-right"></a></button>
